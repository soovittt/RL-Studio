...
const TEMPLATES = [
    ...
    sceneGraph: {
      entities: [
        ...
        ...Array.from({ length: 15 }, (_, i) => ({
          ...
          name: `Wall ${i + 1}`,
          parentId: null,
          transform: { position: [5 + (i % 5), 0, 5 + Math.floor(i / 5)], rotation: [0, 0, 0], scale: [1, 1, 1] },
  ...
  },
  {
    ...
    description: "Multiple agents working together to reach a shared goal. Tests cooperative multi-agent RL.",
    category: "grid",
  ...
  },
  {
    ...
    description: "Continuous 2D space with obstacles. Agent uses continuous actions (velocity) to navigate to goal.",
    category: "continuous",
  ...
  {
    name: "3D Navigation",
    description: "3D environment with agent navigating through obstacles to reach goal. Tests 3D spatial reasoning.",
    category: "3d",
  ...
  },
  {
    ...
    description: "Simple driving environment with road, obstacles, and goal. Agent controls vehicle with steering and acceleration.",
    category: "driving",
