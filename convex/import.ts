...
export const fromPaper = action({
  ...
  handler: async (ctx, args) => {
    try {
      ...
      const envType = lowerContent.includes('continuous') || lowerContent.includes('physics') 
        ? 'continuous2d' 
        : 'grid'
      ...
      return {
        ...
        summary: enhancedResult.extracted.description || enhancedResult.rawContent.substring(0, 500),
        extracted: {
