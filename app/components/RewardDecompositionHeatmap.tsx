    ...
    return (
      <div className="flex flex-col items-center justify-center h-64 text-destructive border border-destructive/50 rounded-lg p-4 bg-destructive/10">
        ...
        <div className="text-xs mt-2 text-muted-foreground">
          Real Python calculations (NumPy, SciPy) are required. Backend: <code className="bg-muted px-1 rounded">{import.meta.env.VITE_ROLLOUT_SERVICE_URL || 'http://localhost:8000'}</code>
        </div>
      </div>
    )
  }
