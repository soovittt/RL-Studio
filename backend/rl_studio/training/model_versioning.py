...
class ModelVersionManager:
    ...
    def load_checkpoint(self, run_id: str, checkpoint_name: Optional[str] = None) -> Optional[str]:
    ...
    def create_version(
        ...
        shutil.copytree(Path(checkpoint).parent, version_dir / "model", dirs_exist_ok=True)
