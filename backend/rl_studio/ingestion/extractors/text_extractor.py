...
Return ONLY valid JSON, no explanations."""
        ...
        async with aiohttp.ClientSession() as session:
            async with session.post(
                ...
                json={
                    "model": "gpt-4o-mini",
                    "messages": [
                        {"role": "system", "content": "You are an expert at parsing RL environment descriptions into structured JSON."},
    ...
    def _build_normalized(self, parsed: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "actionSpace": parsed.get("actionSpace", {
                "type": "discrete",
