    ...
    async def extract(self, input_data: str, **kwargs) -> ExtractionResult:
        ...
        try:
            ...
            normalized = self._merge_results(
                firecrawl_result.normalized_data,
                code_data,
                repo_info
            )
            
            warnings = firecrawl_result.metadata.warnings + code_data.get("warnings", [])
