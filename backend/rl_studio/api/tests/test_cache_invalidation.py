...
def test_asset_cache_invalidation_on_create(client, mock_convex_client, sample_user_id, sample_asset_type_id):
...
def test_asset_cache_invalidation_on_update(client, mock_convex_client, sample_user_id, sample_asset_type_id):
...
def test_asset_cache_invalidation_on_delete(client, mock_convex_client, sample_user_id, sample_asset_type_id):
...
def test_template_cache_invalidation_on_create(client, mock_convex_client, sample_user_id, sample_project_id):
