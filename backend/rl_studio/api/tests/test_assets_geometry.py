...
def test_create_asset_with_geometry_box(client, mock_convex_client, sample_user_id, sample_asset_type_id):
...
def test_create_asset_with_geometry_sphere(client, mock_convex_client, sample_user_id, sample_asset_type_id):
...
def test_create_asset_with_geometry_cylinder(client, mock_convex_client, sample_user_id, sample_asset_type_id):
...
def test_create_asset_without_geometry(client, mock_convex_client, sample_user_id, sample_asset_type_id):
...
def test_update_asset_geometry(client, mock_convex_client, sample_user_id, sample_asset_type_id):
    ...
    update_response = client.patch(
        ...
        json={
            "geometry": {"primitive": "sphere", "params": {"radius": 0.8}}
        }
    )
...
def test_update_asset_remove_geometry(client, mock_convex_client, sample_user_id, sample_asset_type_id):
...
def test_get_asset_with_geometry(client, mock_convex_client, sample_user_id, sample_asset_type_id):
    ...
    create_response = client.post(
        ...
        json={
            "assetTypeKey": "tile",
            "name": "Geometry Asset",
            "geometry": {"primitive": "box", "params": {"width": 5, "height": 2, "depth": 3}},
...
def test_list_assets_with_geometry(client, mock_convex_client, sample_user_id, sample_asset_type_id):
    ...
    geometries = [
        ...
        {"primitive": "cylinder", "params": {"radiusTop": 0.5, "radiusBottom": 0.5, "height": 1}},
    ]
...
def test_clone_asset_preserves_geometry(client, mock_convex_client, sample_user_id, sample_asset_type_id):
    ...
    create_response = client.post(
        ...
        json={
            "assetTypeKey": "tile",
            "name": "Original",
            "geometry": {"primitive": "box", "params": {"width": 2, "height": 3, "depth": 4}},
...
def test_geometry_with_all_primitives(client, mock_convex_client, sample_user_id, sample_asset_type_id):
    ...
    for primitive, params in primitives:
        ...
        assets = mock_convex_client.data["assets"]
        created = next((a for a in assets if a["name"] == f"{primitive.capitalize()} Asset"), None)
