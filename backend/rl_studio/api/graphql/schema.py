...
@strawberry.type
class Query(
    CommonResolver, AssetResolver, SceneResolver, TrainingResolver, ResearchResolver
):
...
@strawberry.type
class Mutation(
    AssetResolver, SceneResolver, TrainingResolver, RolloutResolver, ResearchResolver
):
