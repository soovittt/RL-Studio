...
def sync_run_metadata_to_convex(run_id: str, job_id: str, convex_url: str) -> bool:
    """
...
def sync_detailed_logs_to_convex(run_id: str, convex_url: str, logs: str) -> bool:
    """
            ...
            response = requests.post(
                ...
                json={
                    ...
                    "metadata": {
                        ...
                        "total_batches": (len(log_lines) + batch_size - 1)
                        // batch_size,
                    },
                },
                headers={"Content-Type": "application/json"},
